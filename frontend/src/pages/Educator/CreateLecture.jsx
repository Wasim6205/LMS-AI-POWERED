    ...
    <div className='min-h-screen bg-gray-100 flex items-center justify-center p-4'>
        <div className='bg-white shadow-xl rounded-xl w-full max-w-2xl p-6'>
            ...
            <div className='flex gap-4 mb-6'>
                <button onClick={()=>navigate(`/editcourse/${courseId}`)} className='flex items-center gap-2 px-4 py-2 rounded-md bg-gray-200 hover:bg-gray-300 text-sm font-medium'><FaArrowLeftLong className='' />Back to Course</button>
                <button onClick={handleCreateLecture} disabled={loading} className='px-5 py-2 rounded-md bg-[black] text-white hover:bg-gray-600 transition-all text-sm font-medium shadow'>{loading ? <ClipLoader size={30} color='white' /> : "+ Create Lecture"}</button>
            </div>
