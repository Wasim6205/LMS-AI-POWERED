  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gray-100 px-4'>
      ...
      {step==1 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e)=>e.preventDefault()}>
            <div className=''>
                ...
                <input onChange={(e)=>setEmail(e.target.value)} value={email} id='email' type="email" className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-black' placeholder='you@example.com' required />
            </div>
      ...
      {step==2 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <div className='text-sm text-center mt-4 cursor-pointer' onClick={()=>navigate(-1)}>Back</div>
      </div>}
      ...
      {step==3 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e)=>e.preventDefault()}>
            <div className=''>
                ...
                <input onChange={(e)=>setNewPassword(e.target.value)} value={newPassword} id='password' type="password" className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-black' placeholder='********' required />
            </div>
            <div className=''>
                <label htmlFor="conpassword" className='block text-sm font-medium text-gray-700'>Confirm Password</label>
                <input onChange={(e)=>setConPassword(e.target.value)} value={conPassword} id='conpassword' type="password" className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-black' placeholder='********' required />
            </div>
