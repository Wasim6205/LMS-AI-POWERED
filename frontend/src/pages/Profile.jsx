    ...
    <div className='min-h-screen bg-gray-100 px-4 py-10 flex items-center justify-center'>
      ...
      <div className='bg-white shadow-lg rounded-2xl p-8 max-w-xl w-full relative'>
        ...
        <div className='mt-6 space-y-4'>
          ...
          <div className='text-sm flex items-center justify-start gap-1'>
            <span className='font-semibold text-gray-700'>Enrollerd Courses:</span>
            <span>{userData?.enrolledCourses?.length}</span>
          </div>
        </div>

        <div className='mt-6 flex justify-center gap-4'>
          <button onClick={()=>navigate(`/editprofile`)} className='px-5 py-2 rounded bg-[black] text-white active:bg-[#4b4b4b] cursor-pointer transition'>Edit Profile</button>
        </div>
      </div>
